...
const translations = {
  en: {
    ...
    iAmA: 'I am a', roleCustomer: 'User', roleProvider: 'Healthcare provider', roleOrganizer: 'Organizer',
  ...
  tr: {
    ...
    iAmA: 'Ben bir', roleCustomer: 'Kullanıcı', roleProvider: 'Sağlık sağlayıcısı', roleOrganizer: 'Organizatör',
  ...
  ar: {
    ...
    iAmA: 'أنا', roleCustomer: 'مستخدم', roleProvider: 'مزود رعاية صحية', roleOrganizer: 'منظم',
  ...
  ru: {
    ...
    iAmA: 'Я', roleCustomer: 'Пользователь', roleProvider: 'Медицинский работник', roleOrganizer: 'Организатор',
  ...
  el: {
    ...
    iAmA: 'Είμαι', roleCustomer: 'Χρήστης', roleProvider: 'Πάροχος υγείας', roleOrganizer: 'Διοργανωτής',
  ...
  fr: {
    ...
    iAmA: 'Je suis', roleCustomer: 'Utilisateur', roleProvider: 'Prestataire de soins', roleOrganizer: 'Organisateur',
  ...
  es: {
    ...
    iAmA: 'Soy', roleCustomer: 'Usuario', roleProvider: 'Proveedor de salud', roleOrganizer: 'Organizador',
  ...
  de: {
    ...
    iAmA: 'Ich bin', roleCustomer: 'Benutzer', roleProvider: 'Gesundheitsdienstleister', roleOrganizer: 'Veranstalter',
  ...
  fa: {
    ...
    iAmA: 'من یک', roleCustomer: 'کاربر', roleProvider: 'ارائه‌دهنده خدمات بهداشتی', roleOrganizer: 'برگزارکننده',
