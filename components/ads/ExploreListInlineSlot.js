...
// list_inline on explore — mounted in screens/ExploreScreen.js.
//
// From the category list's renderItem after the 8th card, once.
//
...
export default function ExploreListInlineSlot({ lang, onNavigate }) {
  return <AdSlot position="list_inline" module="explore" lang={lang} onNavigate={onNavigate} />
}
