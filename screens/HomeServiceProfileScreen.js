        ...
        >
          ...
          <View style={s.body}>
            ...
            {!!provider.description && (
              <View style={s.section}>
                <Text style={s.sectionLabel}>{t('hsAbout', lang)}</Text>
            ...
            {/* Contact */}
            <View style={s.section}>
              <Text style={s.sectionLabel}>{t('hsContact', lang)}</Text>
              {provider.phone && (
                <TouchableOpacity
                  style={s.contactRow}
                ...
                >
                  ...
                  <Text style={s.contactAction}>{t('hsCall', lang)}</Text>
                </TouchableOpacity>
              )}
              {provider.whatsapp && (
                <TouchableOpacity
                ...
                >
                  ...
                  <Text style={[s.contactAction, { color: '#25D366' }]}>{t('hsWhatsApp', lang)}</Text>
                </TouchableOpacity>
              )}
            </View>
          </View>
        ...
        <View style={s.ctaWrap}>
          {canCall && (
            ...
            >
              ...
              <Text style={s.ctaText}>{t('hsCall', lang)}</Text>
            </TouchableOpacity>
          )}
          {canWA && (
            <TouchableOpacity
            ...
            >
              ...
              <Text style={s.ctaText}>{t('hsWhatsApp', lang)}</Text>
            </TouchableOpacity>
          )}
        </View>
      </View>
